        ...
        <Flex flexDirection={"row"}>
          <Flex flexDirection={"column"} justifyContent={"center"} w={"60%"}>
            <Stack spacing={4}>
              ...
              <Text fontSize={"xl"}>
                Select from a selection of tokens to transfer to your friends
                and family. Write a message to go along with your token
                transfer. Connect your wallet to get started now!
              </Text>
              <Link href={"/transfer"}>
        ...
        >
          <Stack spacing={4}>
            ...
            <FeatureCard
              ...
              description={
                "Write a message to go along with your token transfer. This is optional but it's always nice to send a message to your friends and family."
              }
            />
          </Stack>
        </Flex>
